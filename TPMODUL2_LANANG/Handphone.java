public class Handphone extends Perangkat {
    ...
    void telfon(int no_hp){
        System.out.println("Handphone berhasil menyambung telepon ke No 62"+no_hp);
    }

    void kirimSMS(int no_hp){
        System.out.println("Handphone berhasil mengirim SMS ke No 62"+no_hp);
    }

    void kirimSMS(int no_hp1, int no_hp2){
        System.out.println("Handphone berhasil mengirim SMS ke No 62"+no_hp1+" dan ke 62"+no_hp2);
    }
